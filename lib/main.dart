...
import 'presentation/bloc/cubit/globalESim/globalESimCubit.dart';
import 'presentation/bloc/cubit/localESim/localESimCubit.dart';
import 'presentation/bloc/cubit/regionalESim/regionalESimCubit.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context) => LocalESimCubit()),
        BlocProvider(create: (context) => RegionalESimCubit()),
        BlocProvider(create: (context) => GlobalESimCubit())
      ],
      child: MaterialApp(
